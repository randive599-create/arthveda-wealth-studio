...
import { TermsContent } from '../src/pages/terms/TermsContent';
import {
  TERMS_INTRO,
  TERMS_META,
...
import { RiskContent } from '../src/pages/risk/RiskContent';
import {
  RISK_INTRO,
  RISK_META,
...
writeRoute(
  ...
  'terms-webpage',
  buildTermsWebPageJsonLd(),
  renderLandingBody('Legal', 'Terms & Conditions', TERMS_INTRO, <TermsContent />),
