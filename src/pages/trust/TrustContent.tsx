/**
 * Why You Can Trust Our Calculators — long-form, server-renderable content
 * (used by both the client page and the prerendered static HTML): trust
 * sections (each with an explanatory body and optional bullet points) and
    ...
    <div className="space-y-8">
      ...
      <Card className="p-6">
        <SectionHeading
          ...
          description="Try our calculators or review how they work."
        />
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {TRUST_INTERNAL_LINKS.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="
