/**
 * Cookie Policy — long-form, server-renderable content (used by both the client
 * page and the prerendered static HTML): cookie policy sections and internal
 * links. Built from existing Card / SectionHeading primitives — no new visual
 * language.
 */
    ...
    <div className="space-y-8">
      ...
      <Card className="p-6">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {COOKIE_INTERNAL_LINKS.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="
