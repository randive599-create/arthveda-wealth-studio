 ...
 * Twitter equivalents, and injects the FAQPage JSON-LD. Existing tags from
 * index.html are updated in place (so there is never a duplicate), and the
 * structured-data script is removed on unmount.
 */
